...
- **Si la tarea incluye UI/frontend:** añadir sección `## DISEÑO REQUERIDO` (para AgenteDesigner)
  y en PASO 0 la referencia `design-specs/[VERSION]-[SLUG].md`; el Designer generará ese archivo
  antes de que el programador ejecute el prompt (ver FLUJO_AGENTES.md)
