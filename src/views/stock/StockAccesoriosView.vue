...
const IMAGEN = '/Images/Accesorios.jpg'
  ...
  <div class="stock-list-page">
    ...
    <template v-else>
      <div class="filters">
        ...
        <input v-model="filtroNombre" type="text" placeholder="Nombre" class="filter-input" />
        ...
        <input v-model="filtroUbicacion" type="text" placeholder="Ubicación" class="filter-input" />
      </div>
      ...
      <div v-else class="cards-grid">
        ...
        >
          ...
          <div class="item-card__body">
            <div class="item-card__id">{{ item.nombre || item.id }}</div>
            <div v-if="item.marca" class="item-card__meta">{{ item.marca }}</div>
            <div v-if="item.modelo" class="item-card__meta">{{ item.modelo }}</div>
            <div v-if="item.numeroSerie" class="item-card__meta">S/N: {{ item.numeroSerie }}</div>
            <div v-if="item.estado" class="item-card__estado">{{ labelEstado(item.estado) }}</div>
            <div v-if="item.cantidad != null && item.unidadMedida" class="item-card__meta">{{ item.cantidad }} {{ item.unidadMedida }}</div>
            <div v-if="item.ubicacion" class="item-card__meta">{{ item.ubicacion }}</div>
          </div>
        </button>
      </div>
    </template>
